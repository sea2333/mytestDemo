...
router.post('/addaccount', (req, res) => {
    let {realname, vipcard, usergroup, phonecall, address} = req.body;
    let sql = `INSERT INTO vipaccount(realname, vipcard, usergroup, phonecall, address)
	 VALUES('${ realname }','${ vipcard }','${ usergroup }','${ phonecall }','${ address }')`
