...
router.post('/addaccount', (req, res) => {
    let {account, password, region,createtime} = req.body;
    let sql = `INSERT INTO account(account, password,createtime) VALUES('${ account }','${ password }','${ createtime }')`
...
router.get('/delaccount', (req, res) => {
	...
	let sql = `delete from account where account='${ account }'`
