  ...
  <div class="goods-manage">
    <el-card class="box-card">
      ...
      <el-table :data="goods" stripe style="width: 100%; margin-bottom:20px;">
        ...
        <el-table-column prop="price" label="进价(元)" width="170"></el-table-column>
        ...
        <el-table-column prop="admin" label="管理">
          <template slot-scope="scope">
            <el-button type="primary" icon="el-icon-edit" circle @click="returndata(scope.row.code)"></el-button>
            <el-button type="danger" icon="el-icon-delete" circle @click="delaccount(scope.row.code)"></el-button>
          </template>
        </el-table-column>
      </el-table>
      <div>
...
export default {
  ...
  methods: {
    ...
    updategoods() {
      ...
      let code = this.updateid;
      let { name, theclass, price, saleprice, number } = this.form;
        updateGoods({
          name,
          theclass,
          price,
