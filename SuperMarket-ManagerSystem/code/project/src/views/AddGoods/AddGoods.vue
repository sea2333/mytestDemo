    ...
    <el-card class="box-card">
      ...
      >
        ...
        <el-form-item label="供应商ID" prop="supplierId">
          <el-input v-model="addGoodsForm.supplierId"></el-input>
        </el-form-item>
        <el-form-item label="厂商ID" prop="factoryId">
          <el-input v-model="addGoodsForm.factoryId"></el-input>
        </el-form-item>
        <el-form-item label="会员享受优惠" prop="preferential">
  ...
  methods: {
    ...
    addGoods() {
      let params = {
        ...
        supplierId: this.addGoodsForm.supplierId,
        factoryId: this.addGoodsForm.factoryId
      };
      console.log(params)
      toAddGoods(params)
        .then(response => {
