    ...
    <el-card class="box-card">
      ...
      <div class="text item">
        ...
        >
          ...
          <el-table-column prop="region" label="用户类型" width="250"></el-table-column>
          ...
          <el-table-column prop="handle" label="操作" show-overflow-tooltip>
            <template slot-scope="scope">
              ...
              <el-button type="danger" icon="el-icon-delete" @click="delaccount(scope.row.name)">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
        <div>
