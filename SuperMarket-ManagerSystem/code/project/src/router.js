...
export default new Router({
  routes: [
    ...
    { path: '/home',redirect: '/home/personal', component: () => import('./views/Home/Home.vue'), children: [
      // 二级路由
      ...
      {path: '/home/supplier', component: () => import('./views/AddGoods/Supplier.vue')},
      {path: '/home/factory', component: () => import('./views/AddGoods/Factory.vue')},
